...
import (
	...
	"github.com/Jakub-Ignatowicz/orders-api-go/model"
	"github.com/Jakub-Ignatowicz/orders-api-go/repository/order"
)
...
func (h *Order) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	case completedStatus:
		if theOrder.ComplitedAt != nil || theOrder.ShippedAt == nil {
			w.WriteHeader(http.StatusBadRequest)
			return
		}
		theOrder.ComplitedAt = &now
	default:
		w.WriteHeader(http.StatusBadRequest)
		return
	}
